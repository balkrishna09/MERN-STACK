...
export default function Template({title,desc1,desc2,image,formtype,setIsLoggedIn}) {
  return (
    <div className='flex w-11/12 max-w-[1160px] py-12 mx-auto gay-y-0 gap-x-12 justify-between'>
        ...
        <div className='relative w-11/12 max-w-[450px] '>
            ...
            <img src={image} alt="student" width={558} heigh={504} loading='lazy' className='absolute -top-4 right-4'/>
        </div>
    </div>
  )
}
